...
class S3_to_kafka(accessKey: String, secretKey: String, endpoint: String, bucket: String,readkey: String,topic: String, bootstrapServers: String) {
  /**
   * 从s3中读取文件内容
   *
   * @return s3的文件内容
  ...
  def readFile(): String = {
    ...
    val s3Object = amazonS3.getObject(bucket, readkey)
